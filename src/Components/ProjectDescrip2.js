...
function ProjectDescrip2 ()  {
    return (
        <div className="ProjectDescrip">
            <div> <p style={{ marginBottom: '3px', marginTop: '28px', fontSize: '47px'}} > group projects: </p> </div>
            <div className="grid-container">
                <div className="grid-item">
                    ...
                    <p style={{  fontSize: '28px', paddingLeft: '18px', marginBottom: '0px', color: "#380652", }}> Spotify Stats </p>
                </div>
            </div>
        </div>
